export default class CardBase extends Phaser.GameObjects.Container {
  constructor(data) {
    ...
    let textName = new Phaser.GameObjects.BitmapText(scene, 0, 0, "press-start",
      name, 16, Phaser.GameObjects.BitmapText.ALIGN_CENTER);
  ...
  deadAnimation() {
    this.scene.tweens.add({
      ...
      repeat: 1,
      yoyo: true,
      onComplete: () => this.spriteImage.setTexture('dead')
    })
  }
}
