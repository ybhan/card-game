...
export default class CardPlayer extends CardDraggable {
  constructor(data) {
    ...
    this.textHealth = new Phaser.GameObjects.BitmapText(this.scene, 0, -102, 'press-start', health);
    this.textMaxHealth = new Phaser.GameObjects.BitmapText(this.scene, -20, -90, 'press-start', health, 12);
    this.spriteArmor = new Phaser.GameObjects.Sprite(this.scene, 50, -80, 'armor');
    this.textArmor = new Phaser.GameObjects.BitmapText(this.scene, 0, -102, 'press-start');
